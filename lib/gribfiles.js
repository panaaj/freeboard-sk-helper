...
// ** GRIB Store Class
class GribStore extends ResourceStoreBase {
                ...
                err=> {
                    if(err) {
                        ...
                        mkdirp(this.savePath, (err)=> {
                            ...
                            else { resolve( this.createSavePaths(this.resources) ) }
                        })
                    }
                    else { resolve( this.createSavePaths(this.resources) ) }
                }
